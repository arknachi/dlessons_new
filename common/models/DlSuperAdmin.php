...
/**
 * This is the model class for table "dl_super_admin".
 *
 * @property integer $id
 ...
 */
class DlSuperAdmin extends ActiveRecord implements IdentityInterface {
    ...
    public function rules() {
        return [
            ...
            [['updated_at','modified_at', 'auth_key'], 'safe'],
            [['status'], 'integer'],
